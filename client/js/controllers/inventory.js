  ...
  function InventoryController($scope, $log, $http) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [
        ...
        {field:'reservation.reservationStart', displayName:'Start', width: 100, enableCellEdit: false, cellFilter: 'date'},
        {field:'reservation.reservationEnd', displayName:'End', width: 100, enableCellEdit: false, cellFilter: 'date'},
        {field:'reservation.date', displayName:'For Date', width: 100, enableCellEdit: false, cellFilter: 'date'},
        {field:'reservation.reservationSpan', displayName:'Span', enableCellEdit: false, width: 70},
